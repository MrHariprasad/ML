...
def main():
    ...
    while not found:
        ...
        # if the individual having the lowest fitness score (i.e., 0), then we know that we have reached the target and break the loop
        ...
        # Perform Elitism, i.e., 10% of the fittest population goes to the next generation
